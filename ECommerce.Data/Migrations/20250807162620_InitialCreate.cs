        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShippingAddresses_AppUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AppUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPosts_IsPublished_IsFeatured",
                table: "BlogPosts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_BlogPostId_IsApproved",
                table: "Comments",
                columns: new[] { "BlogPostId", "IsApproved" });

            migrationBuilder.CreateIndex(
                name: "IX_Comments_BlogPostId_ParentCommentId",
                table: "Comments",
                columns: new[] { "BlogPostId", "ParentCommentId" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactMessages_IsRead_CreatedDate",
                table: "ContactMessages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShippingAddresses_AppUserId_IsDefault",
                table: "ShippingAddresses",
                columns: new[] { "AppUserId", "IsDefault" });
